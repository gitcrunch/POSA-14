...
{	
    ...
    public void print(final String outputString)
    {
         ...
         */
        // TODO - You fill in here.
    	Activity uiActivity = mActivity.get();
    	if (uiActivity != null)
    	uiActivity.runOnUiThread(new Runnable() {public void run() { mTextViewOutput.append(outputString+"\n"); } });
    }
    ...
    {	
    	...
    	Activity uiActivity = mActivity.get();
    	if (uiActivity != null)
    	uiActivity.runOnUiThread(new Runnable() {public void run() { mLatch.countDown(); } });
    }
