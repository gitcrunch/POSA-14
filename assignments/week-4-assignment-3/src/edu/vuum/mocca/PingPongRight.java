...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        SimpleSemaphore mSEMA[] = new SimpleSemaphore[2];
        ...
        public void run() {
            ...
            // TODO - You fill in here.
        	for (int loopNo = 1; loopNo <= mMaxLoopIterations; ++loopNo)
        	{
        			acquire();
        			System.out.println(mStringToPrint+ "(" + loopNo + ")");
        			release();
        			//mLatch.countDown();
    ...
    public static void process(String startString, 
        ...
        if (ping.isInterrupted() || pong.isInterrupted())
